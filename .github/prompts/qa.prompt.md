...
### ⚙️ Settings — External (Cache policy / GitHub OAuth)
| # | 케이스 | 확인 |
|---|--------|------|
| EX-01 | 캐시 정책 GET | `/api/settings/external` 200 (`permanentCache`, `cacheTtlDays`) |
| EX-02 | 캐시 정책 PUT | `/api/settings/external/cache` 저장 |
| EX-03 | GitHub OAuth GET/PUT | `/api/settings/external/github` |
