...
**내장 역할**  
OsWL은 고정된 내장 역할을 제공하지 않습니다. 관리자가 최초 설정 시 사용 가능한 권한 목록에서 역할 템플릿을 직접 생성합니다.
...
관리자가 정의한 이름 있는 권한 묶음(예: "개발자", "보안 분석가"). 하나 이상의 사용자에게 지정됩니다. 템플릿 변경은 해당 템플릿을 보유한 모든 사용자에게 즉시 적용됩니다.
