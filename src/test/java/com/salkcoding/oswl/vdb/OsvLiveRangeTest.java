...
class OsvLiveRangeTest {
    ...
    @CsvSource(value = {"npm;*;false", "crates.io;latest;false", "Go;master;false", "PyPI;>=1;false",
            ...
            "Alpine:v3.18;latest;false", "Alpine:v3.18;1.0-r0;true", "Alpine:v3.18;1.0_rc1-r2;true", "Alpine:v3.18;v1.0;false", "Alpine:v3.18;1.0p1;false", "Alpine:v3.18;1.0a_p1-r2;true", "Alpine:v3.18;1.0a_rc1_p2-r0;true"}, delimiter = ';')
    ...
    @ParameterizedTest
    @CsvSource(value = {"PyPI;fixture/other;false", "PyPI;fixture[extra];false", "PyPI;-fixture;false",
            "PIP;fixture.;false", "pypi;피키지;false", "PyPI;Fixture._-Name;true", "PIP;x;true"}, delimiter = ';')
    void emptyLookupCannotValidateAnInvalidPythonPackageName(String ecosystem, String name, boolean resolved) {
        ...
        server.expect(requestTo("https://api.osv.dev/v1/querybatch"))
                .andRespond(withSuccess("{\"results\":[{}]}", MediaType.APPLICATION_JSON));
        var query = new OsvClient.OsvQuery(ecosystem, name, version);
        var online = client.queryBatch(List.of(query)).getFirst();
        assertThat(online.resolved()).isEqualTo(resolved);
        var store = mock(AirgappedSnapshotService.class);
        when(store.readOsvSnapshot(anyCollection())).thenCallRealMethod();
