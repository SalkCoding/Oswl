 ...
 */
public final class DependencyManifestPatcher {
     ...
     */
    public static Optional<String> patch(String content, String path, String libName, String oldVersion, String newVersion) {
